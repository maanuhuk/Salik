...
bot = telebot.TeleBot('7245349199:AAFBz4ZKFAGqjtjpw-ebnhdi0q3HWMLZ2NM')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "DM Me And Send Popularity To Me In BGMI"
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. VIP Service ")
